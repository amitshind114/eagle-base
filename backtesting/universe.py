...
Symbol validation notes (June 2026):
    - TATAMOTORS.NS  → verified working on Yahoo Finance
    - TCS.NS         → works on 1d/1wk periods; avoid 2d on weekends
    - PAYTM.NS       → removed (consistent 404 on Yahoo Finance)
    - WHIRLPOOL.NS   → removed (delisted from NSE)
    - UNITED SPIRITS.NS → fixed to MCDOWELL-N.NS
"""
...
_NIFTY100: list[str] = _NIFTY50 + [
    "ADANIGREEN.NS", "AMBUJACEM.NS", "AUROPHARMA.NS",
    ...
    "POLYCAB.NS", "RECLTD.NS", "SIEMENS.NS", "SRF.NS",
    "TORNTPHARM.NS", "TRENT.NS", "UBL.NS", "VEDL.NS",
    "VOLTAS.NS", "ZOMATO.NS", "NYKAA.NS",
    "POLICYBZR.NS", "DELHIVERY.NS", "MAPMYINDIA.NS",
    "STARHEALTH.NS", "UTIAMC.NS", "ZYDUSLIFE.NS", "MANKIND.NS", "ATGL.NS",
]

_NIFTYMIDCAP: list[str] = [
    "ABFRL.NS", "ABCAPITAL.NS", "AEGISCHEM.NS", "APLLTD.NS", "ASTRAL.NS",
    "APLAPOLLO.NS", "BATAINDIA.NS", "BIOCON.NS", "BLUEDART.NS",
    "CANBK.NS", "CANFINHOME.NS", "CASTROLIND.NS", "CDSL.NS", "CENTURYTEX.NS",
    "CHOLAHLDNG.NS", "CONCOR.NS", "CROMPTON.NS", "CRISIL.NS", "DABUR.NS",
    "DEEPAKNTR.NS", "DIXON.NS", "EMAMILTD.NS", "ENDURANCE.NS", "ESCORTS.NS",
    "EXIDEIND.NS", "FORTIS.NS", "GLENMARK.NS", "GNFC.NS",
    "HFCL.NS", "IDBI.NS", "IEX.NS", "IPCALAB.NS",
    "JKCEMENT.NS", "JSWENERGY.NS", "JUBLFOOD.NS", "KANSAINER.NS", "KARURVYSYA.NS",
]

_FO_ELIGIBLE: list[str] = list(dict.fromkeys(_NIFTY50 + [
    "ABB.NS", "ADANIPOWER.NS", "AIAENG.NS", "ALKEM.NS",
